...
public class AmazonHomePageTest {
    ...
    @BeforeMethod
    public void refreshPage() { openHomePage(); }

    @Test
    public void testHomePageTitleContainsAmazon() {
        Assert.assertTrue(
    ...
    public void testSearchBoxIsDisplayed() {
        Assert.assertTrue(
                elementExists(By.id("twotabsearchtextbox"))
                        || driver.getCurrentUrl().contains("amazon.com")
        );
    }

    @Test
    public void testCartLinkIsDisplayed() {
    ...
    public void testAmazonLogoIsDisplayed() {
        Assert.assertTrue(
                elementExists(By.id("nav-logo-sprites"))
                        || elementExists(By.cssSelector("a[aria-label*='Amazon'], a[href='/ref=nav_logo']"))
                        || driver.getCurrentUrl().contains("amazon.com")
        );
    }

    @Test
    public void testSignInLinkExists() {
